...
class TreeGrid extends Widget
{
     ...
     *\yii\data\DataProviderInterface|\yii\data\BaseDataProvider视图的数据提供程序。此属性是必需的。
     */
    public $dataProvider;

    /**
     * @var string the default data column class if the class name is not explicitly specified when configuring a data column.
     * Defaults to 'jianyan\treegrid\TreeColumn'.
     * 如果在配置数据列时没有显式指定类名，则设置默认数据列类。
     *默认为“jianyan\treegrid\TreeColumn”。
     */
     ...
     * 为网格视图的容器标记数组HTML属性。
     * @参见\yii\helpers\Html::renderTagAttributes()了解如何呈现属性的详细信息。
     *
     * 设置表格的属性
     */
